...
from getnet_support.entrypoints.ui import build_ui
...
class HealthResponseModel(BaseModel):
    ...
    retriever: Literal["lexical", "semantic"]
...
def build_app(settings: Settings | None = None) -> FastAPI:
    ...
    retriever: RetrieverPort = (
        SemanticRetriever(corpus) if settings.retriever == "semantic" else LexicalRetriever(corpus)
    )
    llm: LLMPort | None = (
